MCCE CONFIGURATION FILE (Quick July 2016)
EDITED TO BE REALLY QUICK 5/16/2014 by MRG
...
f        step 5: post monte carlo (pka)                     (DO_POSTMCCE)
...
/home/mcce/mcce3.5/extra.tpl                                (EXTRA)
/home/mcce/mcce3.5/name.txt MCCE renaming rule.             (RENAME_RULES)

ph       "ph" for pH titration, "eh" for eh titration       (TITR_TYPE)
6.0      Initial pH                                         (TITR_PH0)
...
-----------------------------------------------------------------------------
/home/dmatta/bin/PSII_param                                 (MCCE_HOME)
...
t        Out ms_gold file for Microstate selection          (MS_GOLD_OUT)
...
129      Grids in each DelPhi                               (GRIDS_DELPHI)
...
t        Output readable micristate file from standard monte carlo (RE_MS_OUT)
...
/home/mcce/mcce3.5/bin/delphicpp_release DelPhi executable for potential map              (DELPHI_POTENTIAL_EXE)
...
4.0       dielectric constant for Coulomb's law              (EPSILON_COULOMB)
