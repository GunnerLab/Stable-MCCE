...
c     attenzion non è valido se acenter non nullo!!!
      icx=(igrid+1)/2
      icy=icx
      icz=icx
	inx=nx-icx
...
c     calculate phiclean
      ...
      phiclean= phi+561*q/(eps*r)-phigreen
      write(6,*)"phi:",phi,561*q/(eps*r),phigreen
