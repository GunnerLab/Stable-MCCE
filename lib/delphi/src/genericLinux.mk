SRC1=qdiff4v.F objvertices.F distobj.F timef.F qinttot.F
#
SRC2=elb.f up.f cent4.f rent4.f \
 ...
 encalc4.f wrtgcrg.f  namlen3.f watput.f cfind4.f rfind4.f \
...
#----------------------------------------------------
1:
	-mv -f $(VPATH)/qdiff4v.f $(VPATH)/qdiff4v.F
2:
	-mv -f $(VPATH)/objvertices.f $(VPATH)/objvertices.F
3:
	-mv -f $(VPATH)/distobj.f $(VPATH)/distobj.F
4:
	-mv -f $(VPATH)/timef.f $(VPATH)/timef.F
.F.o:
